...
- **Next — Step 2J.1:** global native design system and visual foundation: final typography, colors, cards, controls, status treatments, spacing, imagery conventions, navigation, and shared loading/empty/offline patterns.
...
**Step 2J.1 — global native design system and visual foundation** is next. It should use this stable identity-asset layer to define final typography, colors, cards, buttons, status treatments, spacing, imagery conventions, avatar/logo sizes, navigation conventions, and shared loading/empty/offline patterns before screen-by-screen polish. It must not change mobile authority or enable Production. Final distribution-archive measurement and rights clearance remain explicit release prerequisites rather than inferred from the completed technical foundation.
