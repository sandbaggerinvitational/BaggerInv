...
- **Next — Step 2J.2:** Today visual and UX polish using the shared design system while preserving Today authority, hierarchy, cached-first behavior, and navigation.
...
**Step 2J.2 — Today visual and UX polish** is next. It should use the shared background, navigation chrome, section headers, cards, statuses, freshness/state treatments, and identity wrappers where they materially improve Today while preserving its certified tournament context, current Match, personal Matches, Tournament Score, immediate Schedule, cached-first behavior, and mobile authority. It must not begin another tab's redesign or enable Production. Final distribution-archive measurement and rights clearance remain explicit release prerequisites rather than inferred from the completed visual foundation.
