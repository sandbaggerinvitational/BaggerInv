...
test("all 2025 Course Profile actions carry bounded History context while Course origins stay explicit", () => {
  ...
  assert.match(coursePage, /courseOriginReturn\(resolvedSearchParams\)/);
  assert.match(coursePage, /!historyReturn && originReturn \? <Link/);
