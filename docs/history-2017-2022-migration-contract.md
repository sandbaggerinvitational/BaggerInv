...
- Scorecard eligibility: expose a scorecard only when the canonical historical evidence satisfies the established complete-scorecard threshold. Do not create missing scorecards for visual parity.
