...
export const claimIntelligenceDerivedBundle = (input, options = {}) => scoringShadowRpc("claim_intelligence_derived_bundle", { input }, { ...options, timeoutMs: options.timeoutMs || 8_000 });
...
export async function recalculateIntelligenceDerivedTournament(tournamentId, { calculatedBy = "Intelligence derived worker" } = {}) {
  ...
  const claim = await claimIntelligenceDerivedBundle({ environment: "PREVIEW", tournament_id: calculated.tournamentId,
