...
export function directorTransactionError(error, fallback = "Tournament update could not be verified after automatic recovery. Review Director Health, then retry the action.", alwaysFallback = false) {
