...
import {
  ADVISORY_PREDICTION_ENGINE_VERSION,
  allocateStrokes,
  courseHandicap,
  formatCode,
  pick,
...
export const WAR_ROOM_CALCULATION_ENGINE_VERSIONS = Object.freeze({
  ...
  matchup: ADVISORY_PREDICTION_ENGINE_VERSION,
  simulation: `match-simulator.js:v1+${ADVISORY_PREDICTION_ENGINE_VERSION}`,
  optimizer: `lineup-optimizer.js:${ADVISORY_PREDICTION_ENGINE_VERSION}`,
  "team-intelligence": "team-intelligence.js:v1",
  calibration: `scorecard-calibration.js:shadow-v1+${ADVISORY_PREDICTION_ENGINE_VERSION}`,
});
