...
function executableConditionGroups(criticalWindow) {
  ...
  return [{ conditions: [{
    type: "hostname", op: "neq", value: PRODUCTION_CANONICAL_HOSTNAME,
  }, {
    type: "hostname", op: "inc", neg: true, value: [...candidateHosts],
  }] }, { conditions: [{
    type: "hostname", op: "inc", value: [...candidateHosts],
  }, {
    ...
    type: "hostname", op: "eq", value: PRODUCTION_CANONICAL_HOSTNAME,
  }, {
    type: "method", op: "ninc",
...
export function buildProductionGoogleWriterCriticalWindowVercelRuleInsert(value) {
  ...
  return deepFreeze({
    ...
    providerOperation: "PATCH /v1/security/firewall/config/draft",
