...
const LIVE_SHEETS = new Set(["Live Matches", "Live Hole Scores", "Live Tournaments", "Net Skins Result"]);
const SEMI_STATIC_SHEETS = new Set(["Matches", "Net Skins", "Tournament Timeline", "Tournament Itinerary", "Guide Sections"]);
