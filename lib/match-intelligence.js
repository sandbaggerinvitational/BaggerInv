...
function confidenceLevel({ prediction, players, historical, scoringIntelligence, format }) {
...
export function buildMatchIntelligence({
  ...
  const confidence = confidenceLevel({ prediction, players, historical, scoringIntelligence, format });
