...
async function readUncached({ scope = "YEARS", year = null, playerId = "", env = process.env, dependencies = {}, timeoutMs } = {}) {
  ...
  const read = await reader({ scope, year, playerId }, { env, timeoutMs });
