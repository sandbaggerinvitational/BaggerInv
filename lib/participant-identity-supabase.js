...
export const verifyPreviewIdentityImpersonation = ({ leaseId, tournamentId, directorPlayerId, playerId }, options) => participantIdentityRpc("verify_preview_identity_impersonation", {
