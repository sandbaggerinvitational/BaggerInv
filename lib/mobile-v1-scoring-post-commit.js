import { recalculateCalcuttaTournament } from "./calcutta-supabase.js";
...
export async function runMobileScoringPostCommit({ tournamentId }, dependencies = {}) {
  ...
  return Promise.allSettled([
    ...
    (dependencies.recalculateCalcuttaTournament || recalculateCalcuttaTournament)(tournamentId, { calculatedBy: actor }),
  ]);
}
