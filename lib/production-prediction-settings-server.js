...
export async function validateProductionPredictionSettings(values = {}, options = {}) {
  return invoke(
    "validate_production_prediction_settings_revision_v1",
    {
      ...
      target_tournament_id: exactTournament(values.targetTournamentId),
      draft_id: exactUuid(values.draftId, "PREDICTION_SETTINGS_DRAFT_ID_REQUIRED"),
      expected_configuration_revision: exactRevision(values.expectedRevision),
    },
    values,
    options,
  );
