...
/** Translate the shared Odds input row into the bounded Step 7B read view. */
export function predictionSettingsViewFromOddsConfiguration(configuration = {}) {
  return {
...
export async function readPredictionSettingsProjection(tournamentId = "", options = {}) {
  ...
  return {
    ...
    payload: {
      ok: true,
      data: predictionSettingsViewFromOddsConfiguration(configuration),
    },
  };
}
