...
const retiredProductionGoogleAuthoring = (domain, googleWriters, description) => Object.freeze({
...
export class DirectorMutationAuthorityError extends Error {
  constructor(diagnostics) {
    ...
    const retired = diagnostics.code === DIRECTOR_MUTATION_ERROR_CODES.PRODUCTION_GOOGLE_AUTHORING_RETIRED;
    super(retired
