...
export const PROTECTED_COLUMN_MAP = Object.freeze({
  ...
  "Calcutta Round Results": merge(columns(READ_ONLY, ["Year", "Round", "Format", "Player ID", "Gross Score", "Net Score", "Full Course Handicap", "Place", "Calcutta Points"])),
  "Calcutta Standings": merge(columns(READ_ONLY, ["Year", "Rank", "Player ID", "Purchase Price", "Round 1 Points", "Round 2 Points", "Round 3 Points", "Total Points", "Round 1 Payout %", "Round 2 Payout %", "Round 3 Payout %", "Overall Payout %", "Total Payout %", "Current Payout Value", "ROI", "Updated At"])),
