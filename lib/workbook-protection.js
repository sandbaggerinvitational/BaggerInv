...
export const PROTECTED_COLUMN_MAP = Object.freeze({
  ...
  "Calcutta Standings": merge(columns(RUNTIME, ["Year", "Rank", "Player ID", "Purchase Price", "Round 1 Points", "Round 2 Points", "Round 3 Points", "Total Points", "Round 1 Payout %", "Round 2 Payout %", "Round 3 Payout %", "Overall Payout %", "Total Payout %", "Current Payout Value", "ROI", "Updated At"])),
