...
const readCachedProductionCurrentTournamentRuntime = cache((env) =>
...
export async function resolveProductionCurrentReadDispatch(
  ...
  const runtime = readRuntime === readProductionCurrentTournamentRuntime
    ? await readCachedProductionCurrentTournamentRuntime(env)
