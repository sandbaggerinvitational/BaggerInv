...
export const TOURNAMENT_GUIDE_MODULES = {
  ...
  dining: {
    sheets: ["Dining"],
    required: { Dining: ["Year", "Day", "Meal", "Cuisine", "Start Time", "End Time", "Location", "Dress Code", "Reservations Required", "Notes", "Sort Order"] },
    yearFilter: "Year = active tournament",
    publishedFilter: "Not applicable; active-year Dining rows are authoritative",
    runtimeQuery: "/tournament-guide/dining",
  },
  gettingAround: {
    sheets: ["Local Guide"],
    required: { "Local Guide": ["Year", "Section", "Title", "Description", "Address", "Phone", "Website", "Sort Order"] },
    yearFilter: "Year = active tournament",
    publishedFilter: "Not applicable; active-year Local Guide rows are authoritative",
    runtimeQuery: "/tournament-guide/getting-around",
  },
  contacts: {
    sheets: ["Important Contacts"],
    required: { "Important Contacts": ["Year", "Category", "Name", "Role", "Phone", "Text Enabled", "Email", "Website", "Sort Order"] },
    yearFilter: "Year = active tournament",
    publishedFilter: "Not applicable; active-year Important Contacts rows are authoritative",
    runtimeQuery: "/tournament-guide/contacts",
  },
};
