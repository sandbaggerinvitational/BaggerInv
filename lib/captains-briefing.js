...
export function briefingPayload({ prediction, teamNames, format, courseName, tee, players, optimizer, historical = {}, simulation = null, pointsAvailable = 3, play = null, strokeMaps = null, holes = [] }) {
  return {
    format,
    course: courseName,
    tee,
