...
export function createHistoricalStatsModel(data = {}) {
  ...
  const invoke = (operation) => (...args) => historicalDataContext.run(normalized, () => operation(...args));
  return Object.freeze({
    source: "request-local-canonical-history",
    data: normalized,
    run: (operation) => historicalDataContext.run(normalized, operation),
    ...
    getAllPlayerStats: invoke(getAllPlayerStats),
    getHeadToHead: invoke(getHeadToHead),
    getSandbaggerRatings: invoke(getSandbaggerRatings),
    getRecords: invoke(getRecords),
    getPartnershipStats: invoke(getPartnershipStats),
    getRivalryStats: invoke(getRivalryStats),
    getHandicapStats: invoke(getHandicapStats),
    getTeamSeason: invoke(getTeamSeason),
    getTournaments: invoke(getTournaments),
