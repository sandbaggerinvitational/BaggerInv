...
export async function refreshCanonical2017To2022HistoricalData() {
  try {
    historicalData = normalizeHistoricalData(await loadCanonical2017To2022HistoricalData());
  } catch (error) {
...
export async function refreshCanonicalCareerHistoricalData() {
  try {
    historicalData = normalizeHistoricalData(await loadCanonicalCareerHistoricalData());
  } catch (error) {
...
export async function refreshCanonical2024HistoricalData() {
  try {
    historicalData = normalizeHistoricalData(await loadCanonical2024HistoricalData());
  } catch (error) {
...
export async function refreshCanonical2023HistoricalData() {
  try {
    historicalData = normalizeHistoricalData(await loadCanonical2023HistoricalData());
  } catch (error) {
