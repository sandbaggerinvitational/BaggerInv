...
function requireIsolatedScoringSheet() {
  ...
  if (credential.credentialSource === "production-worker") {
    const productionOperation = credential.operation === "SCORING_GOOGLE_OUTBOX" ||
      credential.operation === "ROUND_SCORECARDS_ARCHIVE";
