...
const definitions = {
  ...
  "points-per-match": {
    ...
    description:
      "Career point efficiency. Team-format points are divided equally between partners.",
  ...
  "points-per-appearance": {
    ...
    description: "Average individual points earned per tournament appearance.",
...
export function getStatisticsSections() {
  return [
    ...
    {
      title: "Handicap",
      description: "Career tournament-handicap measurements.",
      links: ["average-handicap"],
    },
  ].map((section) => ({
    ...section,
    links: section.links.map((slug) => ({
      slug,
