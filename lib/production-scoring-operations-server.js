...
const RPC_PHASE = Object.freeze({
  read_production_round_scoring_v1: "CURRENT_READS",
  mutate_production_round_scoring_v1: "SCORING_COMMIT",
...
export async function productionScoringOperationsRpc(functionName, input = {}, {
  ...
  if (annual && ['read_production_round_scoring_v1', 'mutate_production_round_scoring_v1'].includes(operationName)) {
    throw operationError('ROUND_TOURNAMENT_UNSUPPORTED', 'Round controls require the certified 2026 tournament.', {}, 403);
  }
