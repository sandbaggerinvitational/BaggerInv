...
async function withRoundScorecardsCredential(env, dependencies, callback) {
...
export async function processNextScorecardArchiveJob({
  ...
  try {
    ...
    const measured = await withRoundScorecardsCredential(env, dependencies, () =>
...
export async function reconcileRoundScorecardsArchives({
  ...
  const grid = await withRoundScorecardsCredential(env, dependencies, () =>
    (dependencies.inspectRoundScorecardsArchiveReadback || inspectRoundScorecardsArchiveReadback)());
  const reports = [];
