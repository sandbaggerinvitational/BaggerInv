...
import { publishedTournamentTimeZone } from "./tournament-timeline.js";
...
export function applyGuideProjectionToHome(data = {}, contentOrProjection = {}, options = {}) {
  ...
  const projectedLive = applyGuideCoursesToTournament(data.liveData || {}, unwrapped);
  const liveData = { ...projectedLive, tournament: { ...projectedLive.tournament,
    timeZone: publishedTournamentTimeZone(unwrapped.content, projectedLive.tournament?.timeZone),
  } };
