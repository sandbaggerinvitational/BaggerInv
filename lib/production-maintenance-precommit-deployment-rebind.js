...
export function productionMaintenancePrecommitDeploymentEnvironment(
  ...
  const exactRuntimeConfiguration =
    ...
    lower(env.ODDS_PUBLICATION_AUTHORITY) === "google" &&
    disabled(env.PRODUCTION_SUPABASE_ODDS_PUBLICATION_ENABLED) &&
    disabled(env.PRODUCTION_SUPABASE_ODDS_GOOGLE_MIRROR_ENABLED) &&
