        ...
        {selected ? <>
          ...
          <div className={styles.actionGrid}>
            ...
            <article aria-label="Tournament membership is read only when no bounded status action is available"><header><strong>2026 membership</strong><span>{productionPlayerAccessStatusLabel(selected.membership.status)}</span></header>
              ...
              {!selected.membership.exists ? <><a className={styles.secondaryButton} href="/admin/director?section=tournament-setup">Open Tournament Setup</a><p>Team assignment is managed through the bounded Tournament Setup workflow, which preserves handicap, pairing, scoring, and side-game readiness.</p></> : null}
