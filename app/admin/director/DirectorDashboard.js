...
export default function DirectorDashboard({ directorName }) {
  ...
  return <section className={styles.shell}>
    ...
    {data.qaTools ? <OperationsSection id="participant-identity-foundation" eyebrow="Preview only · Passport authority" title="Participant Identity Configuration" summary="Validate explicit golfer emails and approve a mapping fingerprint. No Auth users or email are created."><ParticipantIdentityFoundationPanel /></OperationsSection> : null}
